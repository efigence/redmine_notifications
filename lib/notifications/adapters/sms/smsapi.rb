...
class Smsapi
  ...
  def options
    {
      http_proxyaddr: Setting['plugin_redmine_notifications']['proxy_host'],
      http_proxyport: Setting['plugin_redmine_notifications']['proxy_port'],
      ssl_ca_file: Setting['plugin_redmine_notifications']['ssl_ca_file'],
      query: {
        username: Setting['plugin_redmine_notifications']['smsapi_username'],
        password: Setting['plugin_redmine_notifications']['smsapi_password'],
        ...
        test: Setting['plugin_redmine_notifications']['test'] == "1" ? 1 : 0 # nie wysyla wiadomosci
    }}
  end
